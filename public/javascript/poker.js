import { RoyalFlush, StraightFlush, Quads, FullHouse, Flush, Straight, ThreeOfAKind, TwoPair, Pair, HighCard } from './checkHandStrength.js'
...
import { pokerCombinations, ranks, suits, rankValues, randomNumbers } from './helperVariables.js'
...
function checkWin(cards1, cards2) {
  ...
  // console.log(cards1, cards2, firstPlayerCombo, secondPlayerCombo)
